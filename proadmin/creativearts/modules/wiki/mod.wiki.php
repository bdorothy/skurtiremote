...
class Wiki {
	...
	function Wiki($return = FALSE)
	{
		...
		/* ----------------------------------------
		/*
		/*  There are five main kinds of pages in the Creativearts Wiki:
		/*
		/*	- Main/Index
		...
		/* ----------------------------------------
			Fixes a minor bug in Creativearts where the QSTR variable
...
/* Location: ./system/creativearts/modules/wiki/mod.wiki.php */
