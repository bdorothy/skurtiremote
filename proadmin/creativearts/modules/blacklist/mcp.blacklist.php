...
class Blacklist_mcp {
	...
	/**
	 * Download and update Creativearts.com Black- or Whitelist
	 *
	 * @access	private
	 * @return	string
	 */
	function _download_update_list($listtype = "black")
	{
		...
		//  Get Current List from Creativearts.com
		ee()->load->library('xmlrpc');
		ee()->xmlrpc->server('http://ping.Creativearts.com/index.php', 80);
		ee()->xmlrpc->method("Creativearts.{$listtype}list");
...
/* Location: ./system/creativearts/modules/blacklist/mcp.blacklist.php */