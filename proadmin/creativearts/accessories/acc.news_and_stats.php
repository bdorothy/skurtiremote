...
/**
 * Creativearts News and Stats Accessory
 *
 * @package		Creativearts
...
class News_and_stats_acc {
	...
	var $id				= 'newsAndStats';
	var $version		= '1.0';
	var $description	= 'Creativearts News and Stats';
	var $sections		= array();
	...
	function _fetch_news()
	{
		...
		try
		{
			$feed = ee()->rss_parser->create('http://creativelab.com/blog/rss-feed/cpnews/', 60 * 24 * 3);
		}
		catch (Exception $e)
		{
			...
			$ret .= '
				<div>
					<a onclick="window.open(this.href); return false;" href="'.
						ee()->cp->masked_url('http://creativelab.com/blog/').
					'">'.lang('more_news').'</a>
				</div>';
...
/* Location: ./system/creativearts/accessories/acc.news_and_stats.php */