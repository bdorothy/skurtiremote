...
transactions on their site and then notifying Creativearts when the transaction is complete
and accepted.  This allows purchases to not be stored and recorded in the Simple Commerce module
until the transaction is finalized.  Creativearts\'s Simple Commerce module automates all of this
...
/* Location: ./system/creativearts/language/english/simple_commerce_lang.php */
