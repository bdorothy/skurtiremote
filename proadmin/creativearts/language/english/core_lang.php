...
Confirm the fieldtype file is located in the creativearts/third_party/ directory',

'unwritable_cache_folder' =>
'Your cache folder does not have proper permissions.<br>
To fix: Set the cache folder (/creativearts/cache/) permissions to 777 (or equivalent for your server).',

'unwritable_config_file' =>
'Your configuration file does not have the proper permissions.<br>
To fix: Set the config file (/creativearts/config/config.php) permissions to 666 (or equivalent for your server).',
...
/* Location: ./system/creativearts/language/english/core_lang.php */
