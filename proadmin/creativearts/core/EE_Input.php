...
class EE_Input extends CI_Input {
	...
	function filter_get_data($request_type = 'PAGE')
	{
 		...
 		* --------------------------------------------------------------------
 		*
 		* All external links that appear in the Creativearts control panel
		...
		if (isset($_GET['URL']))
		{
			...
			{
				exit('Some components appear to be missing from your Creativearts installation.');
			}
...
/* Location: ./system/creativearts/libraries/EE_Input.php */
