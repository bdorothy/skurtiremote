...
class Ls_standard_measurements_ext {
	
	public $settings 		= array();
	public $description		= 'This extension adds the required measurement Data to Standard Measurement Grid';
	public $docs_url		= 'http://www.sixth.co.in';
	public $name			= 'LS Standard Measurements';
	...
	public function activate_extension()
	{
		...
		$this->settings = array();
		  ...
		  $hooks = array(
   		   'ls_cartthrob_pre_checkout' => 'ls_cartthrob_pre_checkout',      		
    		);
	 ...
	 * @return 
	 */
	public function ls_cartthrob_pre_checkout($data,$order_data)
	{
	print_r($order_data);
