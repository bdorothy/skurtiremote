 ...
 * @package			LS Login
 * @version			1.0.1
 * @author			Raj Sadh <http://sixth.co.in>
 * @copyright 		Copyright (c) 2007-2015 Sixthsense <http://sixth.co.in>
 * @license 		Personal
 * @link			http://sixth.co.in
 * @see 			http://expressionengine.com/user_guide/development/
 */

class Ls_email_login_ext
{
	public $version			= '1.0.1';
	public $name			= 'LS Email Login';
