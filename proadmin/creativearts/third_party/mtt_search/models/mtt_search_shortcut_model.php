 ...
 */
class Mtt_search_shortcut_model extends Mtt_search_model {
	...
	public function get_group_counts($site_id)
	{
		...
		return mtt_flatten_results($query->result_array(), 'num', 'group_id');
	}
	...
	public function validate($data)
	{
		...
		if ( ! empty($data['parameters']))
		{
			...
			{
				$data['parameters'] = mtt_search_decode($data['parameters']);
			}

			// Convert array to json
			if (is_array($data['parameters']))
			{
				$data['parameters'] = mtt_search_encode($data['parameters'], FALSE);
			}
...
/* End of file Mtt_search_shortcut_model.php */