...
class Mtt_search_settings {
	...
	private $_default_settings = array(
		...
		=> "a's able about above according accordingly across actually after afterwards again against ain't
			all al als almost alone along already also although always am among amongst an and another
			...
			becomes becoming been before beforehand behind being believe be beside besides best better between
			...
			except far few fifth first five foled foling fols for former formerly forth four from further
...
// End of file Mtt_search_settings.php