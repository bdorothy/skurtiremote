...
class Zenbu_upd {
	...
	function install()
	{
		...
		*/
		...
		$this->EE->dbforge->add_field($fields);
		$this->EE->dbforge->add_key('cache_id', TRUE);
		
		$this->EE->dbforge->create_table($this->addon_short_name . '_filter_cache');
	...
	function uninstall()
	{
		...
		$this->EE->dbforge->drop_table($this->addon_short_name.'_filter_cache');
