...
$plugin_info = array(
    'pi_name'        => 'Get Entries By Categories [original plugin : pi.category_entry]',
    'pi_version'     => '0.1',
    'pi_author'      => 'Isaac Raway metasushi.com/',
...
//                     case 'order': $orderby = 'cat_order'; break;
	...
	$count = ee()->db->count_all_results('exp_category_posts');
	return $count;
	}
    ...
    {
    return <<<END
ADDED ON 25TH NOVEMBER 2014 RAJ SADH
{exp:ls_seg2cat:total_results category_id="X"}
