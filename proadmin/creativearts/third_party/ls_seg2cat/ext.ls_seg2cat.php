...
// include config file
require PATH_THIRD.'ls_seg2cat/config.php';

/**
 */
class Ls_seg2cat_ext {
	 ...
	 * @var         string
	 */
	public $version = LS_SEG2CAT_VERSION;
	 ...
	 * @var         string
	 */
	public $docs_url = LS_SEG2CAT_DOCS;
	...
	public function __construct($settings = array())
	{
		...
		ee()->load->add_package_path(PATH_THIRD.LS_SEG2CAT_PACKAGE);
	}
	...
	function settings_form($current)
	{
		...
		ee()->cp->set_breadcrumb('#', LS_SEG2CAT_NAME);
	...
	{
		if ($current == '' OR $current == LS_SEG2CAT_VERSION)
		{
			return FALSE;
		}
		...
		$data['version'] = LS_SEG2CAT_VERSION;
...
/* End of file ext.ls_seg2cat.php */