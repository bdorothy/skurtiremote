...
class EE extends EE_Controller {
	...
	function index()
	{
		...
		{
			show_error('Unable to initialize Creativearts.  The EE core does not appear to be defined in your autoload file.  For more information please contact technical support.');
		}
	}
	...
	function _output($output)
	{
			...
			$this->TMPL->template_type != 'js')
		{
			...
			{
				$output .= '<div style="color: #333; background-color: #ededed; margin:10px; padding-bottom:10px;" id="Creativearts_template_debug">';
...
/* End of file ee.php */
/* Location: ./system/creativearts/controllers/ee.php */