	...
	public function _files_filter($state)
	{
		...
		return array(
			...
			'no_results' => sprintf(
				...
				$this->cp->masked_url('http://creativelab.com/creativearts/user-guide/cp/content/files/sync_files.html'),
...
/* File Location: system/creativearts/controllers/cp/content_files.php */
