...
class Homepage extends CP_Controller {
	...
	function index()
	{
		...
		if ($this->session->userdata['group_id'] == 1)
		{
			...
			/*
			C-ARTS : REMOVED VERSION CHECK ON LOGIN TO CP
	 ...
	 *
	 * Requests a file from Creativearts.com that informs us what the current available version
	 * of Creativearts.
	 *
	 * @access	private
	 * @return	bool|string
	...
	{
		$download_url = $this->cp->masked_url('https://store.creativelab.com/manage');
...
/* Location: ./system/creativearts/controllers/cp/homepage.php */
