...
<div id="footer">
	<a rel="external" href="<?=$this->cp->masked_url('http://sixth.co.in')?>"><img src="<?=$cp_theme_url?>images/logo_footer.png" alt="<?=APP_NAME?>" width="109" height="15" /></a>
	<?=(IS_CORE)?' Core':''?> v<?=APP_VER?> <?php echo ' - ';
	echo lang('build'). '&nbsp;'.APP_BUILD;?> - &copy; <?=lang('copyright')?> 2003 - <?= date('Y') ?> <a href="<?=$this->cp->masked_url('http://sixth.co.in/')?>" rel="external">Creativelab, Inc.</a><br />
