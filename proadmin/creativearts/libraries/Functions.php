...
/**
 * Creativearts Core Functions Class
 *
 * @package		Creativearts
 * @subpackage	Core
 * @category	Core
...
class EE_Functions {
	...
	public function prep_conditionals($str, $vars, $safety = 'n', $prefix = '')
	{
		...
		$runner = \Creativelab\Creativearts\Library\Parser\ParserFactory::createConditionalRunner();
		...
		catch (\Creativelab\Creativearts\Library\Parser\Conditional\Exception\ConditionalException $e)
		{
			$thrower = str_replace(
...
/* Location: ./system/creativearts/libraries/Functions.php */