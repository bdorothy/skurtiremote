...
/**
 * Creativearts Action Handler Class
 *
 * Actions are events that require processing. Normally when you use Creativearts,
 ...
 * Creativearts uses only one execution file (index.php) we need a way to know that an
 * action is being requested.
 *
 * The way actions work is this:
 *
 * Anytime a GET or POST request contains the ACT variable, Creativearts will run the Actions class and
 ...
 *
 * When a new module is installed, Creativearts will update the action table.  When a module
...
/* Location: ./system/creativearts/libraries/Actions.php */
