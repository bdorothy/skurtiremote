...
/**
 * Creativearts Channel Entries API Class
 *
 * @package		Creativearts
 * @subpackage	Core
 * @category	Core
...
class Api_channel_entries extends Api {
	...
	function _prepare_data(&$data, &$mod_data, $autosave = FALSE)
	{
		...
		foreach ($result_array as $row)
		{
			...
			// http://creativelab.com/creativearts/user-guide/development/fieldtypes.html#class-variables
...
/* Location: ./system/creativearts/libraries/api/Api_channel_entries.php */
