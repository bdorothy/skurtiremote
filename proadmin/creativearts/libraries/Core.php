...
class EE_Core {
	...
	public function bootstrap()
	{
		...
		define('APP_NAME',		'Creativearts'.(IS_CORE ? ' Core' : ''));
		...
		{
			$theme_path = substr(APPPATH, 0, - strlen(SYSDIR.'/creativearts/')).'themes/';
	...
	public function run_cp()
	{
		...
		if (strncmp(ee()->config->item('doc_url'), 'http://Creativearts.com/docs', 32) == 0)
		{
			ee()->config->update_site_prefs(array('doc_url' => 'http://creativelab.com/creativearts/user-guide/'));
		}
	}
...
/* Location: ./system/creativearts/libraries/Core.php */
