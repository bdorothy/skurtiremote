...
/**
 * Creativearts Template Parser Class
 *
 * @package		Creativearts
 * @subpackage	Core
 * @category	Core
...
class EE_Template {
	...
	public function parse(&$str, $is_embed = FALSE, $site_id = '', $is_layout = FALSE)
	{
		...
		/*	Creativearts tags or PHP in them.
		/*
	 ...
	 *
	 * As Creativearts can include data from other Sites in its installation, we need to validate
	...
	protected function createAnnotation($data)
	{
		...
		{
			$this->annotations = new \Creativelab\Creativearts\Library\Template\Annotation\Runtime();
...
/* Location: ./system/creativearts/libraries/Template.php */
