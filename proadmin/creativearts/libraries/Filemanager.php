...
/**
 * Creativearts Filemanager Class
 *
 * @package		Creativearts
 * @subpackage	Core
...
class Filemanager {
	...
	public function _file_datasource($state, $params)
	{
		...
		$sync_files_url = (REQ == "CP") ?
			ee()->cp->masked_url('http://creativelab.com/creativearts/user-guide/cp/content/files/sync_files.html') :
			'http://creativelab.com/creativearts/user-guide/cp/content/files/sync_files.html';
...
/* Location: ./system/creativearts/libraries/Filemanager.php */