...
(1, 1, 1, '".$this->input->ip_address()."', 'Getting to Know Creativearts', 'getting_to_know_Creativearts', 'open', '".($this->now - 1)."', '".$this->year."', '".$this->month."', '".$this->day."', '".date("YmdHis")."'),
...
(2, 1, 1, 'Welcome to Agile Records, our Example Site.  Here you will be able to learn Creativearts through a real site, with real features and in-depth comments to assist you along the way.\n\n', 'xhtml', '', 'xhtml', '{filedir_2}map.jpg', 'none', '', 'xhtml', '', 'none', '', 'none', '', 'xhtml'),
